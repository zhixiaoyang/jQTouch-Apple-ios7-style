...
{title:"Apple",href:j+"../themes/css/apple.css"},{title:"Apple ios7",href:j+"../themes/css/ios7.css"}]},c.settings);a(b.themeStyleSelector).each(function(b,c){var f=a(c).attr("title");h[f]=!0;l(c,f)});for(var i=0;i<b.themeIncluded.length;i++){var d=b.themeIncluded[i];d.title in h||(c=a('<link title="'+d.title+'" href="'+d.href+'" rel="stylesheet">'),a("head").append(a(c)),h[d.title]=!0,l(c,d.title))}if(b.themeSelectionSelector){for(var n in h)c=a('<li><a href="#" data-title="'+n+'">'+n+"</a></li>"),a(b.themeSelectionSelector).append(c);a(b.themeSelectionSelector).delegate("* > a",
